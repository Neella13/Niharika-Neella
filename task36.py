...
# 4. **Polymorphism**
# **Polymorphism** means "many shapes." It allows methods to be used interchangeably, even if they are of different types. It enables an object to take on multiple forms. The most common 
# form of polymorphism is method overriding, where a subclass provides a specific implementation for a method defined in the parent class.
